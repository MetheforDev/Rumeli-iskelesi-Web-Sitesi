...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "oralet-cesitleri", name: "Oralet Çeşitleri", price: "15", description: "Kivi · Portakal · Karadut · Kuşburnu · Elma · Nane Limon", images: ["/images/menu/Kivi ai.jpg", "/images/menu/Portakal ai.jpg", "/images/menu/Karadut ai.jpg", "/images/menu/Kuşburnu ai.jpg", "/images/menu/Elma çayı ai.jpg", "/images/menu/Nane Limon ai.jpg"] },
      { id: "adacayi", name: "Adaçayı", price: "30", image: "/images/menu/Adaçayı ai.jpg" },
      { id: "demleme-ihlamur", name: "Demleme Ihlamur", price: "100", image: "/images/menu/Demleme Ihlamur ai.jpg" },
