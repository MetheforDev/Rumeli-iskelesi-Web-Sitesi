...
export async function Footer() {
  ...
  return (
    <footer id="contact" className="py-24 px-6 bg-[#030303] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <FadeInView delay={0.2}>
            ...
            <a
              ...
              className="group inline-flex items-center gap-3 px-5 py-3 rounded-full border border-white/10 hover:border-brand-500/50 bg-white/5 hover:bg-brand-600/10 transition-all duration-300 hover:scale-[1.04] active:scale-[0.97]"
            >
        ...
        {/* Google Maps */}
        <FadeInView delay={0.3} className="mt-12 rounded-2xl overflow-hidden border border-white/10">
