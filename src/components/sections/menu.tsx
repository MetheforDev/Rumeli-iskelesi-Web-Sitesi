...
const menuData: MenuCategory[] = [
  {
    ...
    emoji: "🍳",
    items: [
      { name: "Kahvaltı Tabağı", price: "300" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Soğuk Kahve Çeşitleri", price: "100", description: "El yapımı çeşitleri" },
      { name: "Nescafe Express Çeşitleri", price: "100" },
      { name: "Üzüm Suyu", price: "80", description: "Katkısız" },
      { name: "Meyveli Soda", price: "40" },
      { name: "Sade Soda", price: "30" },
      { name: "Cam İçecekler", price: "50" },
      { name: "Kutu İçecekler", price: "65" },
      { name: "0.50 Su", price: "15" },
    ],
  },
  {
    id: "tatlilar",
    ...
    emoji: "🍮",
    items: [
      { name: "San Sebastian", price: "200", badge: "Premium", description: "Ekstra çikolata sos ile servis edilir", allergens: "Süt · Yumurta · Gluten" },
      { name: "Magnolya", price: "160", allergens: "Süt · Yer Fıstığı · Gluten · Yumurta" },
      { name: "Tiramisu", price: "160", allergens: "Süt · Yumurta · Gluten" },
      { name: "Truff", price: "160", allergens: "Süt · Yer Fıstığı · Gluten · Yumurta" },
      { name: "İbiza", price: "160", allergens: "Süt · Gluten" },
      { name: "Cheesecake Çeşitleri", price: "160", allergens: "Süt · Yumurta · Gluten" },
